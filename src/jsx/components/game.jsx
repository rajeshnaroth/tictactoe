...
const Game = function({board}) {
	...
	return  <div className="container game">
		...
		<div className={'col col-lg-4 hidden-md hidden-xs hidden-sm leftPane player' + board.player}></div>
		...
		<div className={'col col-lg-4 hidden-md hidden-xs hidden-sm rightPane player' + board.player}></div>
